...
class Speech_InputPage extends StatefulWidget {
  Speech_InputPage({Key key,  this.title}) : super(key: key);
  ...
  @override
  _Speech_InputPageState createState() => _Speech_InputPageState();
}

enum TtsState { playing, stopped, paused, continued}
class _Speech_InputPageState extends State<Speech_InputPage> {
